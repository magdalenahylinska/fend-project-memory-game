...
*/
const cardsNames = ["fa-diamond","fa-paper-plane-o", "fa-anchor", "fa-bolt", "fa-cube", "fa-leaf", "fa-bicycle", "fa-bomb"];
const cards = cardsNames.concat(cardsNames);
...
function openPairs() {
  ...
  function winner() {
    if (pairsFound === 8) {
      ...
      clearInterval(gameTime); //stop timer
